        ...
        <div class="control-group-container">
            ...
            <div class="control-group" style="border-left: 4px solid #00cc44;">
                ...
                <div style="display: flex; flex-direction: column; gap: 12px; margin-top: 10px;">
                    ...
                    <!-- THEME 1/2 SCALING SIZES (RESTORED) -->
                    <div>
                        <label style="font-size:10px; color:#888; margin-bottom:2px;">BREAKING Size (Themes 1 & 2)</label>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.getElementById('size-breaking').addEventListener('input', e => {
                ...
                document.getElementById('render-breaking-t2').style.fontSize = `${e.target.value * 0.9}px`;
            });
            ...
            document.getElementById('btn-reset-style').addEventListener('click', () => {
                ...
                document.getElementById('color-blur-shade').value = "#ffffff";
                ...
                document.getElementById('hl1-bg').value = "#e61919";
                document.getElementById('hl1-text').value = "#ffffff";
                document.getElementById('hl2-bg').value = "#000000";
                document.getElementById('hl2-text').value = "#ffcc00";
                document.getElementById('hl3-bg').value = "#00cc44";
                document.getElementById('hl3-text').value = "#ffffff";
